...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ll7htfy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ll7htfy.containers.anotherwebservice.com/
...
```
git clone git@github.com:chuyuewei/container-ll7htfy.git
cd container-ll7htfy
```
...
```
docker attach container-ll7htfy
```
